...
print(length(week1_sleep[week1_sleep>8]))
...
column_sums = colSums(grades)
print("column sums")
print(column_sums)

## Total points for each student using `rowSums()`
row_sums = rowSums(grades)
print("Row Sums")
print(row_sums)
...
summary_of_vector <- summary(factor_genre_vector)
print('summary of vector')
print(summary_of_vector)
