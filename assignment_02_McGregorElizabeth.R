...
## Use `setwd()` if needed
setwd("/Users/elizabethmcgregor/Desktop/GitHub/dsc520")
dir()
...
person_df2 <- data.frame(stringsAsFactors = FALSE)
str(person_df2)
...
ex_sheet <- excel_sheets("data/G04ResultsDetail2004-11-02.xls")
print(ex_sheet)
